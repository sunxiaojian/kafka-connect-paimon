...
package io.connect.paimon.operation;
...
/**
 * Local {@link OrphanFilesClean}, it will use thread pool to execute deletion. Code from
 * org.apache.paimon.operation.LocalOrphanFilesClean
 */
public class LocalOrphanFilesClean extends OrphanFilesClean {
    ...
    public LocalOrphanFilesClean(
            FileStoreTable table, long olderThanMillis, Consumer<Path> fileCleaner) {
